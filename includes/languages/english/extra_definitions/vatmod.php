...
define('ENTRY_TVA_INTRACOM_ERROR', 'European Tax number of your Company must contain a minimum of ' . ENTRY_TVA_INTRACOM_MIN_LENGTH . ' characters.');
define('ENTRY_TVA_INTRACOM_TEXT', 'European companies only');
define('ENTRY_CONTROL_TVA_INTRACOM', 'The European Tax number does not match server request. Please, leave it blank.<br />
<!-- Optional BEGIN-->
...
<strong>Slovenia</strong>: SI + 8 numeric characters <br /><!-- Optional END-->');
define('ENTRY_NO_VERIF_TVA_INTRACOM', 'Server is unable to check your European Tax number: please, leave blank');
define('ENTRY_CONTROL_TVA_INTRACOM_COUNTRY', 'European Tax number does not match the country. Please leave it blank if correct number is unknown');
